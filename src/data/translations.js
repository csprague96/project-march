...
const translations = {
  en: {
    ...
    individualNumber: 'Individual No.',
    evacuationType: 'Evacuation type',
    painScale: 'Pain scale',
    injuryLocations: 'Injury locations',
    marchTherapies: 'MARCH therapies',
    massiveHemorrhage: 'M - Massive hemorrhage',
    airway: 'A - Airway',
    respiration: 'R - Respiration',
    circulation: 'C - Circulation',
    secondary: 'S - Secondary',
    medicationsDetailed: 'Medications',
    dose: 'Dose',
    route: 'Route',
    ivFluids: 'IV Fluids / Blood',
    volume: 'Volume',
    firstResponder: 'First responder',
    noFluids: 'No fluids documented.',
  ...
  uk: {
    ...
    // New card fields
    militaryId: 'Військовий №',
    individualNumber: 'ІНД. №',
    evacuationType: 'Тип евакуації',
    painScale: 'Шкала болю',
    injuryLocations: 'Місця поранень',
    marchTherapies: 'Терапія MARCH',
    massiveHemorrhage: 'M - Масивна кровотеча',
    airway: 'A - Дихальні шляхи',
    respiration: 'R - Дихання',
    circulation: 'C - Кровообіг',
    secondary: 'S - Вторинне',
    medicationsDetailed: 'Медикаменти',
    dose: 'Доза',
    route: 'Шлях',
    ivFluids: 'Інфузії / Кров',
    volume: "Об'єм",
    firstResponder: 'Перший рятівник',
    noFluids: 'Інфузії не задокументовано.',
